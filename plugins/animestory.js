let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    await conn.sendMessage(m.chat, { video: { url: dir[Math.floor(Math.random() * dir.length)] }, caption: `https://www.instagram.com/x25__madara?igsh=OWllcnV1NTYzMGtw` }, { quoted: m })
}
